...
public class DestController {
	...
	@RequestMapping(value = "/getYoutubeData", method = RequestMethod.POST)
	public @ResponseBody ArrayList<HashMap<String, Object>> reviewwrite(@RequestParam int whereNum) {
